...
#if you need to rerun a few models for a single crop make sure that 'datafiles' is reduced to match with 'crops'
...
## Run the models ----
  ...
  t <- readRDS("Output/RICH_CDL_BBOX_AGalfalfa_ntiles_02142024.rds")
